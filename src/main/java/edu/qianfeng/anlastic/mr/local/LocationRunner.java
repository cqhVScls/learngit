...
//                StatsUserDimension.class,TimeOutputValue.class,job,true);
        ...
        job.setOutputValueClass(LocationOutputWritableValue.class);
        //设置输出格式
    ...
    private List<Scan> listScans(Job job) {
        ...
        String columns[] = new String[]{
                ...
                EventLogConstant.LOG_COLUMN_NAME_COUNTRY,
                EventLogConstant.LOG_COLUMN_NAME_PROVINCE,
                EventLogConstant.LOG_COLUMN_NAME_CITY
        };
